...
#def main(): # commented out for debugging
    ...
    parser.add_argument('--path2trained',action='store',dest='path2trained',default='test_data/thesis_2class/')
    ...
    args.filename = 'test_data/thesis_2class_test/test/test'  # location of data that is to be classified
